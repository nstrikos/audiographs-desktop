...
FocusScope {
    ...
    height: 30
    width: 100
    anchors.verticalCenter: graphLabel9.verticalCenter
    ...
    Keys.onSpacePressed: controlsMainRect.openColorDialog("derivative color")
    Keys.onEnterPressed: controlsMainRect.openColorDialog("derivative color")
    Keys.onReturnPressed: controlsMainRect.openColorDialog("derivative color")
    Rectangle {
        ...
        MouseArea {
            ...
            onPressed: {
                window.stopAudio()
                controlsMainRect.openColorDialog("derivative color")
            }
        }
    }
}
